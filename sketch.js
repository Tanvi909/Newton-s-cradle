...
function keyPressed(){
	...
	if(keyCode=== DOWN_ARROW){
		Matter.Body.applyForce(bob2.body, bob2.body.position, 
			{x:-50, y:45});
	}

	if(keyCode=== LEFT_ARROW){
		Matter.Body.applyForce(bob3.body, bob3.body.position, 
			{x:-50, y:45});
	}
...
//why doesn't bobObject work in keyPressed function? 
//we didn't use any chain, so how are the bob and the string connected? 
